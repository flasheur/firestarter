...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page( THEMENAME, 'WnG panel', 'edit_theme_options', 'wngpanel', 'optionsframework_options_page', get_template_directory_uri() . '/firestarter/res/images/wng_logo_ampoule_icn.png');
