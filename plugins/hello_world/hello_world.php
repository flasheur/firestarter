...
Plugin URI: http://www.wng.ch
Description: I don't know right fu**ing now
Version: 1.0
Author: SRa
Author URI: http://www.wng.ch
Author Email: simon.rapin@wng.ch
License:
...
class HelloWorld {
	...
	function __construct() {
		...
		load_plugin_textdomain( 'hello-world-locale', false, dirname( plugin_basename( __FILE__ ) ) . '/lang' );
	...
	public function register_admin_page() {
		...
		add_menu_page( 'Hello World', 'Hello World', 'add_users', 'hello_world/views/admin.php' );
	
	} // end register_admin_page
